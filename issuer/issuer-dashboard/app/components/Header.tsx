...
const Header: React.FC<HeaderProps> = ({ currentPage, agentStatus, onRefresh }) => {
  const getPageTitle = () => {
    switch (currentPage) {
      case 'issue': return 'Issue New Credential';
      case 'issued': return 'Issued Credentials';
      default: return 'Pending Credentials';
    }
  };

  const getPageDescription = () => {
    switch (currentPage) {
      case 'issue': return 'Create and issue student credentials';
      case 'issued': return 'View previously issued credentials';
      default: return 'View pending credentials awaiting issuance';
    }
  };
